...
<div class="container my-4">
        ...
        <form action="" method="POST" class="mt-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="subtitle" name="subtitle" value="" placeholder="Sous-titre" aria-describedby="subtitleHelpBlock">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="picture" name="picture" value="" placeholder="image jpg, gif, svg, png" aria-describedby="pictureHelpBlock">
