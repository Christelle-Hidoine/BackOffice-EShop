...
class CategoryController extends CoreController
{
    ...
    public function editCategory($categoryId)
    {
        ...
        // contient la donnée de $params['id'] cad l'id de la catégorie à modifier
        //dump($categoryId);
    ...
    public function createOrUpdateCategory($categoryId = null)
    {
        ...
        if (!empty($_POST)) {
            ...
            // Avant de créer / modifier la catégorie, on doit vérfier si on a eu une ou plusieurs erreurs
            ...
            if (empty($errorList)) {
                ...
                if ($isUpdate) {
                    ...
                    // On est en mode create ==> on créer uns instance de Category
                    $modelCategory = new Category();
                }
                ...
                // Dans le template category-add-update, on récupère $viewData['category'] et $viewData['errors']
